...
export default function Paraphrase() {
  ...
  const executor = useMutation<any, any, any>(payload => RobotsService.paraphrase(payload))
  ...
  return (
    <div className="space-y-4">
      <div>
        <div className='font-black text-lg'>Parafrase Teks</div>
        <div className='text-slate-500'>Masukkan paragraf yang ingin kamu perbaiki. LiterasiAI akan melakukan parafrase teks tersebut menjadi lebih menarik.</div>
      </div>
      <div>
        {result !== null && (
          <div className='space-y-2'>
            ...
            <div className='border rounded-lg'>
              <div className='border-b p-4 space-y-2'>
                <div className='font-bold text-sm text-slate-500'>Paragraf hasil parafrase</div>
                <div>
                  <textarea
                    readOnly
        ...
        {result === null && (
          <div className='space-y-4'>
            ...
            <div>
              ...
              >
                <PaperAirplaneIcon className="w-4"/> Proses Parafrase
              </button>
            </div>
          </div>
        )}
